...
export default class SimpleVertecApi {
    ...
    processQueue() {
        ...
        while (this.requestQueue.length > 0 && this.activeRequests < this.maxConcurrentRequests) {
            const { xmlString, resolve, reject } = this.requestQueue.shift();
            this.activeRequests++;
        ...
        // Process slow lane queue
        while (this.slowLaneQueue.length > 0 && this.activeSlowLaneRequests < this.maxConcurrentSlowLaneRequests) {
            const { xmlString, resolve, reject } = this.slowLaneQueue.shift();
            this.activeSlowLaneRequests++;
    ...
    request(xmlString) {
        ...
        headers.VertecSessionTag = `${this.sessionForRequest}`;
