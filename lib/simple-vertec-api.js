...
export class SimpleVertecApi {
    ...
    multiSelect(queryArray) {
        ...
        let selectObjectArray = [];
        _.each(queryArray, query => {
            let singleSelectObject = this.buildSelectObject(...query);
            selectObjectArray.push(singleSelectObject.Query);
        });

        let selectObject = this.buildSelectObject({
            Query: selectObjectArray
        });

        let xmlString = this.buildXml(selectObject.Query.Selection);
