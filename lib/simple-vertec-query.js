...
export default class SimpleVertecQuery {
    ...
    getCacheKey() {
        let cacheKey = [
            ...
            (this.options.cacheKey ? this.options.cacheKey : md5(SimpleVertecQuery.api.buildXmlStringFromObject({query: this.options.query, params: this.options.params, fields: this.options.fields}))),
