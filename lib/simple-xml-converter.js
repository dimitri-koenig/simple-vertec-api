...
export default class XmlConverter {
    ...
    static toXml(object, indentationSpaces = 0) {
        const newInstance = new XmlConverter();
    ...
    processObjectProperty(key, value) {
        if (_.isPlainObject(value)) {
            const convertedObject = this.convertObject(value);
    ...
    createNode(key, value) {
        let indentation = _.pad('', this.indentLevel * this.indentationSpaces);
